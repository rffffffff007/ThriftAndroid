...
public class TProtocolUtil {
  ...
  /**
   * add max collection skip size to avoid endless loop.
   * modified by renfei.
   */
  private static int maxCollectionSize = 2048;
  
  public static void setMaxCollectionSize(int size){
  ...
  throws TException {
    ...
    switch (type) {
      ...
      case TType.MAP:
        ...
        for (int i = 0; i < map.size && i < maxCollectionSize; i++) {
      ...
      case TType.SET:
        ...
        for (int i = 0; i < set.size && i < maxCollectionSize; i++) {
      ...
      case TType.LIST:
        ...
        for (int i = 0; i < list.size && i < maxCollectionSize; i++) {
